...
<img src="https://res.cloudinary.com/dgcfg5cwe/image/upload/v1645764785/1_quzksv.png" style="width: 450px; border-radius: 8px; box-shadow: 0 4px 6px -1px rgb(0 0 0 / 10%), 0 2px 4px -2px rgb(0 0 0 / 10%);"></img>
